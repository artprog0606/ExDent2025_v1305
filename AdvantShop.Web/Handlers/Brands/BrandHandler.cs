...
namespace AdvantShop.Handlers.Brands
{
    public class BrandHandler
    {
        ...
        {
            var availableCategories = BrandService.GetCategoriesByBrand(brandId);
            var categories = BrandService.GetParentCategoriesbyChildsId(availableCategories.Keys.ToList());
            ...
            var brandCategories = categories
