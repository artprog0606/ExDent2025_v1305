...
angular
    ...
    .factory('mapApiLoad', [
        ...
        function (yaMapSettings) {
            ...
            var loadUrl = () =>
                'https://api-maps.yandex.ru/2.1?apikey=' + API_KEY + '&lang=' + yaMapSettings.lang + '&coordorder=' + yaMapSettings.order;
            var _loading = false;
    ...
    .controller('YaMapCtrl', [
        ...
        '$attrs',
        '$parse',
        function ($scope, mapApiLoad, $attrs, $parse) {
            var self = this;
                ...
                compile: function (tElement) {
                    ...
                    return function (scope, element, attrs) {
                        ...
                        scope.$watch('yaCenter', function (newValue) {
                            ...
                            getCenterCoordinates(center).then(function (coords) {
                                if (!mapPromise) {
            ...
            return {
                ...
                compile: function (tElement) {
                    ...
                    return function (scope, element, attrs, yaMap) {
                        ...
                        var showAll = $parse(attrs.showAll)(scope.$parent);
                        if (showAll) {
                            ...
                            var addEventHandler = function () {
                                ...
                                timeout = $timeout(function () {
                                    ...
                                    if (bounds) {
                                        map.setBounds(bounds, { checkZoomRange: true, zoomMargin: 9 });
                                    }
                                }, 300);
                            };
