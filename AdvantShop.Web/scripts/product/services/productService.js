...
function productService($http, $q) {
    ...
    service.getFirstPaymentPrice = function (price, discount, discountAmount) {
        return $http
            .get('productExt/getfirstpaymentprice', {
                params: { price: price, discount: discount, discountAmount: discountAmount },
            })
            .then(function (response) {
                return response.data;
            });
    ...
    service.getOfferStocks = function (offerId) {
        return $http.get('productExt/getofferstocks', { params: { offerId: offerId } }).then(function (response) {
            return response.data;
        });
    };
}
