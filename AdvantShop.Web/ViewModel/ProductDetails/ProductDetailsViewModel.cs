...
namespace AdvantShop.ViewModel.ProductDetails
{
    public class ProductDetailsViewModel : BaseProductViewModel
    {
        ...
        public SettingsDesign.eCartAddTypeButton CartAddTypeButton { get; set; }
        ...
        public string AmountPriceString { get; set; }
        ...
        public SizeChartViewModel SizeChart { get; set; }
        ...
        public float Weight
        {
            get
            {
                if (_weight != null) return _weight.Value;
                
                (_weight, _weightUnits) = Offer.GetWeightAndUnits();
                return _weight ?? 0;
            }
        }
        ...
        public string WeightUnits
        {
            get
            {
                if (_weightUnits != null) return _weightUnits;
