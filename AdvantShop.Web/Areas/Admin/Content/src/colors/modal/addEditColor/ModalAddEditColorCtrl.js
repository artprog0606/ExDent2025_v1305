(function (ng) {
    ...
    var ModalAddEditColorCtrl = function ($uibModalInstance, $http, $q, $timeout, toaster, Upload, $translate, isMobileService) {
        var ctrl = this;
        ...
        ctrl.$onInit = function () {
            ...
            ctrl.getFormData().then(function (data) {
                ...
                if (ctrl.mode == 'add') {
                    ...
                    ctrl.getColor(ctrl.colorId).then(function (data) {
