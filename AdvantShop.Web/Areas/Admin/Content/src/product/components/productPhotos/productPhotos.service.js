(function (ng) {
    ...
    var productPhotosService = function ($http) {
        ...
        service.getPhotoCategories = function () {
            return $http.get('product/getPhotoCategories').then(function (response) {
                return response.data;
            });
        };
        ...
        service.deletePhotos = function (ids) {
            return $http.post('product/deletePhotos', { photoIds: ids }).then(function (response) {
                return response.data;
            });
        };
        ...
        service.changePhotoCategory = function (photoId, photoCategoryId) {
            return $http.post('product/changePhotoCategory', { photoId: photoId, photoCategoryId: photoCategoryId }).then(function (response) {
                return response.data;
            });
        };
