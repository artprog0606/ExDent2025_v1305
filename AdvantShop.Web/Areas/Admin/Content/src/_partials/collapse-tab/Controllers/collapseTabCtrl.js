(function (ng) {
        ...
        ctrl.init = function init(tabs) {
            ...
            if (tabs.length != 0) {
                dropdownHTML =
                    ...
                    $translate.instant('Admin.Js.CollapseTab.More') +
        ...
        ctrl.autocollapse = function (tabs, dropdownWidth, otherEl, otherElWidth) {
            ...
            if (widthChildren + parseFloat(dropdownWidth) + parseFloat(otherElWidth) >= tabsWidth) {
                ...
                if (dropdownListEl.length != 0) {
                    if (
                        tabsWidth <
                        widthChildren + parseFloat(dropdownWidth) + parseFloat(dropdownListEl[dropdownListEl.length - 1].dataset.widthEl)
                    ) {
                        return;
                    } else {
                        while (
    ...
    ng.module('collapseTab').controller('CollapseTabCtrl', CollapseTabCtrl);
