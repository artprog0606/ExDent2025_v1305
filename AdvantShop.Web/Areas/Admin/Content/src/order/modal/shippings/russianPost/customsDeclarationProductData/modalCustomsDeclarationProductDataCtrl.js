(function (ng) {
        ...
        ctrl.gridOptions = ng.extend({}, uiGridCustomConfig, {
            columnDefs: [
                ...
                },
                {
                    ...
                    cellTemplate:
                        '<div class="ui-grid-cell-contents"><div ng-bind="grid.appScope.$ctrl.gridExtendCtrl.getCountryName(COL_FIELD)"></div></div>',
                    enableCellEdit: true,
                    enableSorting: false,
                    type: 'select',
                    minWidth: 200,
                    uiGridCustomEdit: {
                        ...
                        editDropdownOptionsArray: [{ label: '----', value: '' }].concat(
                            Object.keys(ctrl.countriesCodes)
                                .sort(function (a, b) {
                                    return ctrl.countriesCodes[a] < ctrl.countriesCodes[b] ? -1 : 1;
                                })
    ...
    ng.module('uiModal').controller('ModalRussianPostCustomsDeclarationProductDataCtrl', ModalRussianPostCustomsDeclarationProductDataCtrl);
})(window.angular);
