(function (ng) {
    ...
    var AudioPlayerCtrl = function ($http, $element, $scope) {
        ...
        ctrl.initAudio = function (src) {
            ...
            ctrl.audio.addEventListener('error', function () {
                ctrl.noAudio = true;
                ctrl.isplaying = false;
                ctrl.audio = null;
                $scope.$apply();
        ...
        function timeupdate() {
            ...
            if (!ctrl.duration) ctrl.duration = formatTime(ctrl.audio.duration);
            $scope.$apply();
        }
    };
    ...
    ng.module('audioPlayer', []).controller('AudioPlayerCtrl', AudioPlayerCtrl);
})(window.angular);
