...
namespace AdvantShop.News
{
    public class NewsItem
    {
        ...
        public ENewsProductsDisplayMode ProductsDisplayMode { get; set; }
        ...
        public enum ENewsProductsDisplayMode
        {
            [Localize("Admin.News.AddEdit.ENewsProductsDisplayMode.Vertically")]
            Vertically = 0,
            [Localize("Admin.News.AddEdit.ENewsProductsDisplayMode.Horizontally")]
            Horizontally = 1,
        }
    }
}