    ...
    public class NewsService
    {
        ...
        public static int InsertNews(NewsItem news)
        {
            var id = SQLDataAccess.ExecuteScalar<int>(
                "Insert Into [Settings].[News] ([NewsCategoryID],[Title],[TextToPublication],[TextToEmail],[TextAnnotation],[ShowOnMainPage],[AddingDate],[UrlPath],[Enabled],[ProductsDisplayMode]) " +
                "Values (@NewsCategoryID, @Title, @TextToPublication, @TextToEmail, @TextAnnotation, @ShowOnMainPage, @AddingDate, @UrlPath, @Enabled, @ProductsDisplayMode); " +
                ...
                new SqlParameter("@ProductsDisplayMode", news.ProductsDisplayMode)
                );
        ...
        public static bool UpdateNews(NewsItem news)
        {
            SQLDataAccess.ExecuteNonQuery(
                ...
                "TextAnnotation=@TextAnnotation, ShowOnMainPage=@ShowOnMainPage, AddingDate=@AddingDate, UrlPath=@UrlPath, [Enabled]=@Enabled, ProductsDisplayMode=@ProductsDisplayMode " +
                "Where NewsId=@NewsID",
                CommandType.Text,
        ...
        private static NewsItem GetNewsFromReader(SqlDataReader reader)
        {
            return new NewsItem
            {
                ...
                ProductsDisplayMode = (NewsItem.ENewsProductsDisplayMode)SQLDataHelper.GetInt(reader, "ProductsDisplayMode")
            };
        }
        ...
        public static List<ProductModel> GetNewsProductModels(int newsId, List<int> warehouseIds = null)
        {
