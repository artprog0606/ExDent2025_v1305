...
{
    public class PecPointDeliveryMapOption : BaseShippingOption, PointDelivery.IPointDeliveryMapOption
    {
        public PecPointDeliveryMapOption()
        {
        }

        public PecPointDeliveryMapOption(ShippingMethod method, float preCost)
            : base(method, preCost)
        {
        ...
        [JsonIgnore]
        public List<PecPoint> CurrentPoints { get; set; }
        ...
        {
            var opt = option as PecPointDeliveryMapOption;
