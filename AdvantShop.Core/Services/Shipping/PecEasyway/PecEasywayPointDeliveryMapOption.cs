...
{
    public class PecEasywayPointDeliveryMapOption : BaseShippingOption, PointDelivery.IPointDeliveryMapOption
    {
        public PecEasywayPointDeliveryMapOption()
        {
        }

        public PecEasywayPointDeliveryMapOption(ShippingMethod method, float preCost)
            : base(method, preCost)
        {
        ...
        [JsonIgnore]
        public List<PecEasywayPoint> CurrentPoints { get; set; }
        ...
        {
            var opt = option as PecEasywayPointDeliveryMapOption;
