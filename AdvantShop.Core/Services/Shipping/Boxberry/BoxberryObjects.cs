...
namespace AdvantShop.Core.Services.Shipping.Boxberry
{
    ...
    [Serializable]
    public class BoxberryObjectPointDescription : BoxberryErrorObject
    {
        // 'Code'=>'Код в базе boxberry',
        public string Code { get; set; }
        // 'Name'=>'Наименование ПВЗ',
        ...
        // 'OnlyPrepaidOrders'=>'Если значение "Yes" - точка работает только с полностью оплаченными заказами',
        [JsonConverter(typeof(BoolConverter))]
        public bool PrepaidOrdersOnly { get; set; }
    ...
    public class BoxberryOrder
    {
        ...
        public BoxberryOrderExportInfo Export { get; set; }
    ...
    [Serializable]
    public class BoxberryOrderExportInfo
    {
        ...
        [JsonProperty(PropertyName = "transporterGuid")]
        public string TransporterGuid { get; set; }
    }
