...
namespace AdvantShop.ExportImport
{
    public enum CategoryFields
    {
        ...
        [StringName("showonmain")]
        [Localize("Core.ExportImport.CategoryFields.ShowOnMainPage")]
        [CsvFieldsStatus(CsvFieldStatus.String)]
        ShowOnMainPage,
        ...
        [StringName("relatedcategories")]
        [Localize("Core.ExportImport.CategoryFields.RelatedCategories")]
        [CsvFieldsStatus(CsvFieldStatus.String)]
        RelatedCategories,

        [StringName("similarcategories")]
        [Localize("Core.ExportImport.CategoryFields.SimilarCategories")]
        [CsvFieldsStatus(CsvFieldStatus.String)]
        SimilarCategories,

        [StringName("relatedproperties")]
        [Localize("Core.ExportImport.CategoryFields.RelatedProperties")]
        [CsvFieldsStatus(CsvFieldStatus.String)]
        RelatedProperties,

        [StringName("similarproperties")]
        [Localize("Core.ExportImport.CategoryFields.SimilarProperties")]
        [CsvFieldsStatus(CsvFieldStatus.String)]
        SimilarProperties,

        [StringName("sizechart")]
        [Localize("Core.ExportImport.CategoryFields.SizeChart")]
        [CsvFieldsStatus(CsvFieldStatus.String)]
        SizeChart,
